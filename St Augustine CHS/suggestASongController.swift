...
class suggestASongController: UIViewController {
    ...
    @IBAction func suggestPressed(_ sender: Any) {
        let alert = UIAlertController(title: "Are you sure you want to spend \(Defaults.requestSong) points to request a song? (You currently have \(allUserFirebaseData.data["points"] ?? "error") points)", message: "Songs not chosen will be removed after 2 days from the date they were requested. No refunds.\n\nAdministration will be able to see who requested what song and have the power to ban those who request inappropriate or irrelevant content. Do not spam request songs.", preferredStyle: .alert)
